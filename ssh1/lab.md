...
1. Установить OpenSSH на локальную машину.
2. Сгенерировать SSH ключи с помощью команды ssh-keygen.
3. Скопировать публичный ключ на удаленный сервер с помощью команды ssh-copy-id.
4. Проверить возможность авторизации на удаленном сервере с использованием SSH ключей.
